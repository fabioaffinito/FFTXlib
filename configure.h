...
#define   __CONF_DFLAGS         " -D__OPENMP -D__INTEL -D__DFTI -D__MPI -D__SCALAPACK"
#define   __CONF_CPP            "cpp"
#define   __CONF_CPPFLAGS       "-P -traditional"

#define   __CONF_F90            "ifort"
#define   __CONF_MPIF90         "mpiifort"
#define   __CONF_F90FLAGS       "$(FFLAGS) -nomodule -qopenmp"
#define   __CONF_F77            "ifort"
#define   __CONF_FFLAGS         "-O2 -assume byterecl -g -traceback -qopenmp"
...
#define   __CONF_LDFLAGS        "-static-intel  -qopenmp"
#define   __CONF_IMOD           "-I"

#define   __CONF_BLAS_LIBS      "-L/cineca/prod/opt/compilers/intel/pe-xe-2016/binary/mkl/lib/intel64 -lmkl_intel_lp64  -lmkl_intel_thread -lmkl_core"
